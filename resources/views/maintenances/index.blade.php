...
@section('contents')
            ...
            @foreach ($E_PLAN as $item)
               <tr>
                  ...
                  <td style="text-align: left;">
                     ...
                     ประเภทงบ: <strong>{{ $item->Budget_NAME }}</strong><br>
                  ...
                  <td class="text-center align-middle">
                     <div class="btn-group" role="group">
                        ...
                        <form action="{{ route('maintenances.destroy', $item->PLAN_ID) }}" method="POST" onsubmit="return confirm('ต้องการปิดใช้งานหรือไม่?')" class="p-0">
                           @csrf
                           @method('DELETE')
   ...
   <script>
      function exportFilteredData() {
         ...
         const exportUrl = `{{ route('export.data', ['type' => 'maintenances']) }}?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
