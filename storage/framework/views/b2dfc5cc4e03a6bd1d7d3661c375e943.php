    <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-xl">
          <div class="modal-content">
             <form method="POST" action="<?php echo e(route('insidewarehouses.update', $E_PLAN->PLAN_ID)); ?>">
                <?php echo csrf_field(); ?>
                   ...
                   <div class="row row-cols-1 row-cols-lg-4">
                      <div class="col mb-3">
                         ...
                         <select class="form-select" id="BUDG_YEAR" name="BUDG_YEAR" required>
                            ...
                            ?>
                            <option value="<?php echo e($nextYear2 + 543); ?>" <?php echo e($E_PLAN->BUDG_YEAR == $nextYear2 + 543 ? 'selected' : ''); ?>>
                               <?php echo e($displayedNextYear2); ?></option>
                            <option value="<?php echo e($nextYear + 543); ?>" <?php echo e($E_PLAN->BUDG_YEAR == $nextYear + 543 ? 'selected' : ''); ?>>
                               <?php echo e($displayedNextYear); ?></option>
                            <option value="<?php echo e($currentYear + 543); ?>" <?php echo e($E_PLAN->BUDG_YEAR == $currentYear + 543 ? 'selected' : ''); ?>>
                      ...
                      <div class="col mb-3">
                         ...
                         <select class="form-select" id="Budget_ID" name="Budget_ID" required>
                            ...
                            <?php $__currentLoopData = $E_BUDGET; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $BUDGET): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <option value="<?php echo e($BUDGET->Budget_ID); ?>" <?php echo e($E_PLAN->Budget_ID == $BUDGET->Budget_ID ? 'selected' : ''); ?>>
                      ...
                      <div class="col mb-3">
                         ...
                         <select class="form-select" id="TYPE_ID" name="TYPE_ID" required>
                            ...
                            <?php $__currentLoopData = $E_TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <option value="<?php echo e($type->TYPE_ID); ?>" <?php echo e($E_PLAN->TYPE_ID == $type->TYPE_ID ? 'selected' : ''); ?>>
                      ...
                      <div class="col mb-3">
                         <span>หมวดวัสดุ</span>
                         <input class="form-control" list="categories" id="PRODCT_CAT_ID" name="PRODCT_CAT_ID" placeholder="หมวดวัสดุ" value="<?php echo e($E_PLAN->PRODCT_CAT_ID); ?>" required>
                         ...
                         <input type="hidden" id="PRODCT_CAT_NAME" name="PRODCT_CAT_NAME" value="<?php echo e($E_PLAN->PRODCT_CAT_NAME); ?>">
                      </div>
                   </div>
                </div>
...
<?php /**PATH /var/www/financial_test/resources/views/insidewarehouses/modal_edit.blade.php ENDPATH**/ ?>