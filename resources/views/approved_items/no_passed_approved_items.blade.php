...
@section('contents')
               ...
               <tr>
                  ...
                  <td class="text-center align-middle">
                     ...
                     @if ($item->USAGE_STATUS_ID == 1 && Auth::user()->id == '114000041')
                        <form action="{{ route('approved_items_plans.approved', $item->PLAN_ID) }}" method="POST">
                           @csrf
                           @method('PATCH')
   ...
   <script>
      function exportFilteredData() {
         ...
         const exportUrl = `{{ route('export.data', ['type' => 'no_passed_approved_items']) }}?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
