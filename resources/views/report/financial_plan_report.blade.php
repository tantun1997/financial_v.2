...
@section('contents')
   ...
   <div class="row row-cols-1 row-cols-lg-3 g-4">
      <div class="col">
         <a href="{{ route('plan_report', ['name_report' => 'administration_report']) }}" class="card-link">
            <div class="card">
               <div class="card-body">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td colspan="3" style="text-align: center">วงเงินรวม
                              <strong> {{ number_format(round($Administration_total), 0) }}</strong>
                              บาท
                           </td>
                        </tr>
                     </tbody>
      ...
      <div class="col">
         <a href="{{ route('plan_report', ['name_report' => 'nursing_report']) }}" class="card-link">
            <div class="card">
               <div class="card-body">
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td colspan="3" style="text-align: center">วงเงินรวม
                              <strong>{{ number_format(round($Nursing_total), 0) }}</strong>
                              บาท
                           </td>
                        </tr>
                     </tbody>
      ...
      <div class="col">
         <a href="{{ route('plan_report', ['name_report' => 'secondary_report']) }}" class="card-link">
            <div class="card">
               <div class="card-body">
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td colspan="3" style="text-align: center">วงเงินรวม
                              <strong>{{ number_format(round($Secondary_total), 0) }}</strong>
                              บาท
                           </td>
                        </tr>
                     </tbody>
      ...
      <div class="col">
         <a href="{{ route('plan_report', ['name_report' => 'primary_report']) }}" class="card-link">
            <div class="card">
               <div class="card-body">
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td colspan="3" style="text-align: center">วงเงินรวม
                              <strong>{{ number_format(round($Primary_total), 0) }}</strong>
                              บาท
                           </td>
                        </tr>
                     </tbody>
      ...
      <div class="col">
         <a href="{{ route('plan_report', ['name_report' => 'supporting_report']) }}" class="card-link">
            <div class="card">
               <div class="card-body">
                  ...
                  <table class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td colspan="3" style="text-align: center">วงเงินรวม
                              <strong>{{ number_format(round($Supporting_total), 0) }}</strong>
                              บาท
                           </td>
                        </tr>
                     </tbody>
