<?php $__env->startSection('title', 'ขออนุมัติ - แผนวัสดุคลังย่อย'); ?>
...
<?php $__env->startSection('contents'); ?>
      ...
      <table id="plan_table" class="table-bordered table" style="width:100%">
         ...
         <tbody>
            <?php $__currentLoopData = $E_PLAN; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  <td>
                     เลขที่: <?php echo e($item->PLAN_ID); ?> <br>
                  ...
                  <td>
                     <span style="color: #2a60f3">วงเงินรวม:
                        ...
                        บาท</span><br>
                     จำนวนวัสดุ: <?php echo e($item->Total_QTY); ?>
                  ...
                  <td class="text-center align-middle">
                     <div class="btn-group" role="group">
                        <a href="<?php echo e($item->TYPE_ID == 30 ? route('outsidewarehouses.show', $item->PLAN_ID) : ($item->TYPE_ID == 31 ? route('insidewarehouses.show', $item->PLAN_ID) : '#')); ?>"
                           type="button" class="btn btn-outline-primary btn-sm" style="white-space: nowrap;">ดูข้อมูล</a>
                        <form action="<?php echo e(route('approved_items_stores.destroy', $item->PLAN_ID)); ?>" method="POST" onsubmit="return confirm('Delete?')" class="p-0">
                           <?php echo csrf_field(); ?>
                     ...
                     <?php if(Auth::user()->id == '114000041'): ?>
                        <?php if($item->REQ_APPROVED_ID == 1): ?>
                           <form id="approval-form-<?php echo e($item->PLAN_ID); ?>" action="<?php echo e(route('approved_items_stores.approved', $item->PLAN_ID)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
   ...
   <script>
      function exportFilteredData() {
         ...
         const exportUrl = `<?php echo e(route('export.data', ['type' => 'approved_items_stores'])); ?>?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/approved_items/approved_items_stores.blade.php ENDPATH**/ ?>