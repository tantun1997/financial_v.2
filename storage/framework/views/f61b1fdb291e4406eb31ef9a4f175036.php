...
<?php $__env->startSection('contents'); ?>
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
            <a href="<?php echo e(route('report', ['name_report' => 'administration_report'])); ?>" class="card-link">
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center">วงเงินรวม
                                        <?php echo e(number_format(round($Administration_total), 0)); ?>
        ...
        <div class="col">
            <a href="<?php echo e(route('report', ['name_report' => 'nursing_report'])); ?>" class="card-link">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center">วงเงินรวม
                                        <?php echo e(number_format(round($Nursing_total), 0)); ?>
        ...
        <div class="col">
            <a href="<?php echo e(route('report', ['name_report' => 'secondary_report'])); ?>" class="card-link">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center">วงเงินรวม
                                        <?php echo e(number_format(round($Secondary_total), 0)); ?>
        ...
        <div class="col">
            <a href="<?php echo e(route('report', ['name_report' => 'primary_report'])); ?>" class="card-link">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center">วงเงินรวม
                                        <?php echo e(number_format(round($Primary_total), 0)); ?>
        ...
        <div class="col">
            <a href="<?php echo e(route('report', ['name_report' => 'supporting_report'])); ?>" class="card-link">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" style="text-align: center">วงเงินรวม
                                        <?php echo e(number_format(round($Supporting_total), 0)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/report/financial_report.blade.php ENDPATH**/ ?>