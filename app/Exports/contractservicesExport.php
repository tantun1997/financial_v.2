...
class contractservicesExport implements FromCollection, WithHeadings, WithStyles
{
    ...
    {
        // ตั้งชื่อเรื่อง
        $sheet->setCellValue('A1', 'ชื่อเรื่อง: แผนการจัดซื้อจัดจ้าง ประเภทค่าจ้างเหมาบริการ');
