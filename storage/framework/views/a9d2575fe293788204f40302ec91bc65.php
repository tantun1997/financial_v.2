<?php $__env->startSection('title', 'รายละเอียดแผนซ่อม'); ?>
...
<?php $__env->startSection('contents'); ?>
   ...
   <div class="row">
      <div class="col-lg-12">
         <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal" data-action="<?php echo e(route('repairs.update', $E_PLAN->PLAN_ID)); ?>">
               แก้ไขข้อมูล
            </button>
      ...
      <div class="col-lg-12">
         <div style="display: flex; justify-content: flex-end; align-items: center; margin-bottom: 10px;">
            <div style="display: flex; align-items: center;">
               ...
               <button onclick="generatePdf(<?php echo e($E_PLAN->PLAN_ID); ?>, 'repairs')" class="btn btn-danger mr-1">
               ...
               <?php if($E_PLAN->USAGE_STATUS_ID == 1 && Auth::user()->id != '114000041'): ?>
                  <?php if($E_PLAN->REQ_APPROVED_ID == 0): ?>
                     <form action="<?php echo e(route('repairs.approved', $E_PLAN->PLAN_ID)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                  ...
                  <?php $__currentLoopData = $EQUIP_LIST; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                        <td style="text-align: center; vertical-align: middle;">
                           <form action="<?php echo e(route('repairs.update_equip_used', $item->EQUP_ID)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('PATCH'); ?>
                        ...
                        <td style="text-align: left; white-space: nowrap; vertical-align: middle;">
                           <div class="form-container">
                              <form action="<?php echo e(route('repairs.update_equip', $item->EQUP_ID)); ?>" method="POST" class="equip-form" id="equip-form-<?php echo e($item->EQUP_ID); ?>">
                                 <?php echo csrf_field(); ?>
                                 <?php echo method_field('PATCH'); ?>
                                 <div class="view-mode">
                        ...
                        <td class="text-center align-middle">
                           ...
                           <div class="view-mode">
                              <div class="btn-group" role="group">
                                 ...
                                 <form action="<?php echo e(route('repairs.destroy_equip', $item->EQUP_ID)); ?>" method="POST" onsubmit="return confirm('Delete?')" class="p-0">
                                    <?php echo csrf_field(); ?>
   ...
   <?php echo $__env->make('repairs.modal_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/repairs/show.blade.php ENDPATH**/ ?>