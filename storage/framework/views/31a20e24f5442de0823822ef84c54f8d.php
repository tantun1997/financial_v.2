                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id='add_equip_table' class="table table-custom table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $VW_EQUIPMENT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="text-align: center; vertical-align: middle; width: 5%;">
                                                <button class="btn btn-outline-success btn-sm"
                                                    onclick="addEquipment('<?php echo e($item->EQUP_LINK_NO); ?>', '<?php echo e($E_PLAN->PLAN_ID); ?>', '<?php echo e($E_PLAN->TYPE_NUMBER); ?>')">
                                                    เพิ่ม
                                                </button>
                                            </td>
                                            <td style="text-align: left; width: 70%;">
                                                <div><strong>หมายเลข:</strong> <?php echo e($item->EQUP_ID); ?></div>
                                                <div><strong>ชื่อรายการ:</strong> <?php echo e($item->EQUP_NAME); ?></div>
                                                <div><strong>ราคา:</strong> <?php echo e(number_format($item->EQUP_PRICE)); ?>

                                                    บาท</div>
                                            </td>
                                            <td style="text-align: left;">
                                                <div><strong>แผนก:</strong> <?php echo e($item->TCHN_LOCAT_NAME); ?></div>
                                                <div><strong>อายุการใช้งาน:</strong> <?php echo e(number_format($item->age)); ?>
...
<?php /**PATH /var/www/financial_test/resources/views/layouts/modal_add_equip.blade.php ENDPATH**/ ?>