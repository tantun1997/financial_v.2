<?php $__env->startSection('title', 'ผ่านอนุมัติ - แผนจัดซื้อจัดจ้าง'); ?>
...
<?php $__env->startSection('contents'); ?>
   ...
   <div style="max-width: 100%; overflow-x: auto; overflow-y: auto;">
      ...
      <table id="plan_table" class="table-bordered table" style="width:100%">
         ...
         <tbody>
            <?php $__currentLoopData = $E_PLAN_PASSED; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  <td>
   ...
   <script>
      function exportFilteredData() {
         ...
         const exportUrl = `<?php echo e(route('export.data', ['type' => 'passed_approved_items'])); ?>?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/approved_items/passed_approved_items.blade.php ENDPATH**/ ?>