<?php $__env->startSection('title', 'ขออนุมัติ - แผนจัดซื้อจัดจ้าง'); ?>
...
<?php $__env->startSection('contents'); ?>
               ...
               <tr>
                  ...
                  <td style="white-space: nowrap;">
                     ...
                     <?php else: ?>
                        ...
                        <br>คงเหลือ:
                        <span style="color: green"><?php echo e(number_format(round($item->Remaining_Price, 2), 2)); ?></span>บาท
                     <?php endif; ?>
                  ...
                  <td class="text-center align-middle">
                     ...
                     <?php if($item->USAGE_STATUS_ID == 1 && Auth::user()->id == '114000041'): ?>
                        <form id="approval-form-<?php echo e($item->PLAN_ID); ?>" action="<?php echo e(route('approved_items_plans.approved', $item->PLAN_ID)); ?>" method="POST">
                           <?php echo csrf_field(); ?>
   ...
   <script>
      function exportFilteredData() {
         ...
         const exportUrl = `<?php echo e(route('export.data', ['type' => 'approved_items_plans'])); ?>?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/approved_items/approved_items_plans.blade.php ENDPATH**/ ?>