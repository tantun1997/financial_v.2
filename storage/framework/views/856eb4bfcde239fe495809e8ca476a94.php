<?php $__env->startSection('title', 'รายละเอียดแผนวัสดุนอกคลัง'); ?>
...
<?php $__env->startSection('contents'); ?>
   ...
   <div class="row">
      <div class="col-lg-12">
         <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button class="btn btn-primary" data-action="<?php echo e(route('outsidewarehouses.update', $E_PLAN->PLAN_ID)); ?>" data-bs-target="#editModal" data-bs-toggle="modal" type="button">
               แก้ไขข้อมูล
            </button>
         </div>
         ...
         <div style="display: flex; justify-content: flex-end; align-items: center; margin-bottom: 10px;">
            <div style="display: flex; align-items: center;">
               ...
               <?php if(Auth::user()->id != '114000041'): ?>
                  <form id="approval-form" action="<?php echo e(route('outsidewarehouses.approved', $E_PLAN->PLAN_ID)); ?>" method="POST">
                     <?php echo csrf_field(); ?>
               ...
               <?php if(Auth::user()->id == '114000041'): ?>
                  <?php if($E_PLAN->REQ_APPROVED_ID == 1): ?>
                     <form id="approval-form-<?php echo e($E_PLAN->PLAN_ID); ?>" action="<?php echo e(route('outsidewarehouses.approved', $E_PLAN->PLAN_ID)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                     ...
                     <?php $__currentLoopData = $EQUIP_LIST; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td style="text-align: center; vertical-align: middle;">
                              <form action="<?php echo e(route('outsidewarehouses.update_equip_used', $item->PRODCT_ID)); ?>" method="POST">
                                 <?php echo csrf_field(); ?>
                                 <?php echo method_field('PATCH'); ?>
                           ...
                           <form class="equip-form" id="equip-form-<?php echo e($item->PRODCT_ID); ?>" action="<?php echo e(route('outsidewarehouses.update_equip', $item->PRODCT_ID)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('PATCH'); ?>
                              <td>
                           ...
                           <td class="text-center align-middle" style="white-space: nowrap">
                              <div class="view-mode">
                                 <div class="btn-group mb-2" role="group">
                                    ...
                                    <form class="p-0" action="<?php echo e(route('outsidewarehouses.destroy_equip', $item->PRODCT_ID)); ?>" method="POST" onsubmit="return confirm('Delete?')">
                                       <?php echo csrf_field(); ?>
                                 ...
                                 <div>
                                    <?php if(Auth::user()->id == '114000041'): ?>
                                       <form id="approval-form-<?php echo e($item->PRODCT_ID); ?>" action="<?php echo e(route('outsidewarehouses.approved_list_product', $item->PRODCT_ID)); ?>" method="POST">
                                          <?php echo csrf_field(); ?>
                                          <?php echo method_field('PATCH'); ?>
   ...
   <?php echo $__env->make('outsidewarehouses.modal_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <?php echo $__env->make('outsidewarehouses.modal_add_product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/outsidewarehouses/show.blade.php ENDPATH**/ ?>