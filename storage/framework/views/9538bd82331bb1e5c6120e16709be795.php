    <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form method="POST" action="<?php echo e(route('potentials.update', $E_PLAN->PLAN_ID)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/financial_test/resources/views/potentials/modal_edit.blade.php ENDPATH**/ ?>