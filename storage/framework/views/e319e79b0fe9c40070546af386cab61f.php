               ...
               <?php $__currentLoopData = $plan_true; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if(!in_array($item->TCHN_LOCAT_NAME, $seenNames)): ?>
                     ...
                     <tr class="clickable-row" data-bs-toggle="collapse" data-bs-target="#itemDetail1<?php echo e($key); ?>" aria-expanded="false" aria-controls="itemDetail1<?php echo e($key); ?>"
                        ...
                        <td><?php echo e(number_format(round($item->total_price), 2)); ?> </td>
                        <td><?php echo e(number_format(round($item->total_current_price), 2)); ?></td>
                        <td><?php echo e(number_format(round($item->total_price - $item->total_current_price), 2)); ?></td>
                     </tr>
                  <?php endif; ?>
                  <?php
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/report/report.blade.php ENDPATH**/ ?>