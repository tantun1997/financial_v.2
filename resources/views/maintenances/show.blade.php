            ...
            <div class="card-body">
               <div class="info-container">
                  ...
                  <div class="info-item">
                     ...
                     <span class="info-value">{{ \Carbon\Carbon::createFromFormat('d/m/Y H:i', $E_PLAN->CREATE_DATE)->addYears(543)->format('d/m/Y H:i') }}
                     </span>
                  </div>
                  <div class="info-item">
         ...
         <div style="display: flex; justify-content: flex-end; align-items: center; margin-bottom: 10px;">
            <div style="display: flex; align-items: center;">
               ...
               @if ($E_PLAN->USAGE_STATUS_ID == 1 && Auth::user()->id == '114000041')
                  <form id="approval-form-{{ $E_PLAN->PLAN_ID }}" action="{{ route('maintenances.approved', $E_PLAN->PLAN_ID) }}" method="POST">
                     @csrf
                     @method('PATCH')
