...
<body>
    ...
    <table width="100%" class="header" style="vertical-align: bottom;">
        <tr>
            ...
            <td class="table_doted_left">
                กลุ่มงาน/ฝ่าย/งาน<?php echo e($PLAN_DEPT); ?>&nbsp;&nbsp;&nbsp;โทร. <?php echo e($tel); ?></td>
        </tr>
    </table>
    <table width="100%" class="header" style="vertical-align: top;">
        <tr>
            <td width="30px" class="headerText">ที่</td>
            <td class="table_doted_left">สส 0033/ผ.<?php echo e($id); ?></td>
    ...
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
        <tr>
            ...
            <td style="padding-left:50px; border-bottom: 1px dotted #999;"><?php echo e($PLAN_DEPT); ?></td>
        </tr>
        <tr>
            <td width="50px"></td>
            <td colspan="2" style="word-break: keep-all;  text-align: justify;">
                ได้รับอนุมัติให้ดำเนินการตามแผนเงินบำรุง/งบประมาณ
                ประจำปี <?php echo e($PLAN_SET_YEAR); ?> โดยมีรายละเอียดดังนี้
            </td>
        </tr>
    </table>
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: justify; word-spacing: -0.3px;">
                                <?php echo e($count++); ?>. <span style="border-bottom: 1px dotted #999;">
                                    <?php echo e($EQUP['EQUP_NAME']); ?> </span>ราคา
                                <span style="border-bottom: 1px dotted #999;">
                                    <?php echo e(number_format($EQUP['EQUP_QTY'], 0)); ?>x<?php echo e(number_format($EQUP['EQUP_CURRENT_PRICE'], 2)); ?>
            ...
            <td width="50%">
                ...
                <table width="100%" style="vertical-align: top; padding-bottom: 3px; font-size: 10pt;">
                    ...
                    <tr>
                        ...
                        <td>แผนเงินบำรุง/งบประมาณ ปี <?php echo e($PLAN_SET_YEAR); ?></td>
                    </tr>
                    <tr>
...
<?php /**PATH /var/www/financial_test/resources/views/pdf/TemplatePage1.blade.php ENDPATH**/ ?>