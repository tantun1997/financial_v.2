    ...
    <?php $__env->startSection('title', 'แผนสอบเทียบเครื่องมือ'); ?>
    ...
    <?php $__env->startSection('contents'); ?>
       ...
       <div class="mb-3">
          <?php if($E_CLOSE_PLAN->status == 'Y'): ?>
             <button type="button" class="btn btn-primary" id="addItemButton" data-bs-toggle="modal" data-bs-target="#addModal" data-action="<?php echo e(route('calibrations.store')); ?>">
                + เพิ่มรายการ
             </button>
          <?php endif; ?>
                   ...
                   <tr>
                      ...
                      <td class="text-center align-middle">
                         <div class="btn-group" role="group">
                            <a href="<?php echo e(route('calibrations.show', $item->PLAN_ID)); ?>" type="button" class="btn btn-outline-primary btn-sm" style="white-space: nowrap;">ดูข้อมูล</a>
                            <form action="<?php echo e(route('calibrations.destroy', $item->PLAN_ID)); ?>" method="POST" onsubmit="return confirm('ต้องการปิดใช้งานหรือไม่?')" class="p-0">
                               <?php echo csrf_field(); ?>
                         ...
                         <?php if($item->USAGE_STATUS_ID == 1 && Auth::user()->id == '114000041'): ?>
                            <form id="approval-form-<?php echo e($item->PLAN_ID); ?>" action="<?php echo e(route('calibrations.approved', $item->PLAN_ID)); ?>" method="POST">
                               <?php echo csrf_field(); ?>
       ...
       <!-- Include the modal -->
       <?php echo $__env->make('calibrations.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
       ...
       <script>
          function exportFilteredData() {
             ...
             const exportUrl = `<?php echo e(route('export.data', ['type' => 'calibrations'])); ?>?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
          ...
          document.addEventListener('DOMContentLoaded', function() {
             ...
             document.querySelectorAll('.form-check-input').forEach((checkbox) => {
                checkbox.addEventListener('change', function() {
                   ...
                   fetch('<?php echo e(route('calibrations.close_plan')); ?>', {
                         method: 'POST',
                         headers: {
                         ...
                         if (status === 'Y') {
                            if (!addItemButton) {
                               ...
                               button.setAttribute('data-action',
                                  '<?php echo e(route('calibrations.store')); ?>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/calibrations/index.blade.php ENDPATH**/ ?>