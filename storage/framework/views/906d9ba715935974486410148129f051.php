<?php $__env->startSection('title', 'ไม่ผ่านอนุมัติ - แผนจัดซื้อจัดจ้าง'); ?>
...
<?php $__env->startSection('contents'); ?>
   ...
   <div style="max-width: 100%; overflow-x: auto; overflow-y: auto;">
      ...
      <table id="plan_table" class="table-bordered table" style="width:100%">
         ...
         <tbody>
            <?php $__currentLoopData = $E_PLAN_NO_PASSED; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                  <td>
                  ...
                  <td class="text-center align-middle">
                     <div class="btn-group" role="group">
                        <a href="<?php echo e($item->TYPE_ID == 1
                        ...
                        <form action="<?php echo e(route('approved_items_plans.destroy', $item->PLAN_ID)); ?>" method="POST" onsubmit="return confirm('Delete?')" class="p-0">
                           <?php echo csrf_field(); ?>
                     ...
                     <?php if($item->USAGE_STATUS_ID == 1 && Auth::user()->id == '114000041'): ?>
                        <form action="<?php echo e(route('approved_items_plans.approved', $item->PLAN_ID)); ?>" method="POST">
                           <?php echo csrf_field(); ?>
   ...
   <script>
      function exportFilteredData() {
         ...
         const exportUrl = `<?php echo e(route('export.data', ['type' => 'no_passed_approved_items'])); ?>?PLAN_SET_YEAR=${PLAN_SET_YEAR}&TCHN_LOCAT_NAME=${TCHN_LOCAT_NAME}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/approved_items/no_passed_approved_items.blade.php ENDPATH**/ ?>