...
<body>
    ...
    <table width="100%" class="header" style="vertical-align: bottom;">
        <tr>
            ...
            <td class="table_doted_left">
                กลุ่มงาน/ฝ่าย/งาน <?php echo e($TCHN_LOCAT_NAME); ?>&nbsp;&nbsp;&nbsp;โทร. <?php echo e($tel); ?></td>
        </tr>
    </table>
    <table width="100%" class="header" style="vertical-align: top;">
        <tr>
            <td width="30px" class="headerText">ที่</td>
            <td class="table_doted_left">สส 0033/ว.<?php echo e($id); ?></td>
            <td width="50px" class="headerText">วันที่</td>
            <td width="170px" class="table_doted_center">&nbsp; <?php echo e($dateExport); ?> &nbsp;</td>
        </tr>
    </table>
    ...
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
        <tr>
            ...
            <td style="padding-left:50px; border-bottom: 1px dotted #999;"><?php echo e($TCHN_LOCAT_NAME); ?></td>
        </tr>
        <tr>
            <td width="50px"></td>
            <td colspan="2" style="word-break: keep-all;  text-align: justify;">
                ได้รับอนุมัติให้ดำเนินการตามแผนเงินบำรุง/งบประมาณ
                ประจำปี <?php echo e($BUDG_YEAR); ?> โดยมีรายละเอียดดังนี้
            </td>
        </tr>
    </table>
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
    ...
    <table width="100%" style="vertical-align: top;">
        <tr>
            ...
            <td width="5px">3.</td>
            <td>
                รายละเอียดของงานที่จะซื้อ/จ้าง จำนวน <?php echo e($Total_Used); ?> รายการ ดังนี้
                ตามเอกสารแนบ
            </td>
        </tr>
        <tr>
                    ...
                    <?php $__currentLoopData = $List_Equip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $key =
                                $item->PRODCT_NAME .
                                '-' .
                                $item->PRODCT_WITHDRAW_QTY .
                                '-' .
                                round($item->PRODCT_CURRENT_PRICE, 2);
                            if (array_key_exists($key, $EQUPs)) {
                                $EQUPs[$key]['PRODCT_WITHDRAW_QTY'] += $item->PRODCT_WITHDRAW_QTY;
                            } else {
                                $EQUPs[$key] = [
                                    'PRODCT_NAME' => $item->PRODCT_NAME,
                                    'PRODCT_WITHDRAW_QTY' => $item->PRODCT_WITHDRAW_QTY,
                                    'PRODCT_CURRENT_PRICE' => round($item->PRODCT_CURRENT_PRICE, 2),
                                ];
                            }
                        ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <?php $__currentLoopData = $EQUPs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $EQUP): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td width="65px"></td>
                            <td style="text-align: justify; word-spacing: -0.3px;">
                                <?php echo e($count++); ?>. <span style="border-bottom: 1px dotted #999;">
                                    <?php echo e($EQUP['PRODCT_NAME']); ?> </span> จำนวน
                                <span style="border-bottom: 1px dotted #999;">
                                    <?php echo e(number_format($EQUP['PRODCT_WITHDRAW_QTY'], 0)); ?>x<?php echo e(number_format($EQUP['PRODCT_CURRENT_PRICE'], 2)); ?>

                                </span> เป็นเงิน
                                <span style="border-bottom: 1px dotted #999;">
                                    <?php echo e(number_format($EQUP['PRODCT_WITHDRAW_QTY'] * $EQUP['PRODCT_CURRENT_PRICE'], 2)); ?>
        ...
        <tr>
            ...
            <td>
                วงเงินที่จะซื้อ/จ้าง <span
                    style="border-bottom: 1px dotted #999;"><?php echo e(number_format(round($Remaining_Price, 2), 2)); ?>

                </span>บาท
                <span style="border-bottom: 1px dotted #999;">(<?php echo e($Remaining_Price_Text); ?>)</span>
            </td>
        </tr>
    </table>
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
            ...
            <td width="50%">
                ...
                <table width="100%" style="vertical-align: top; padding-bottom: 3px; font-size: 10pt;">
                    ...
                    <tr>
                        ...
                        <td>แผนเงินบำรุง/งบประมาณ ปี <?php echo e($BUDG_YEAR); ?></td>
                    </tr>
                    <tr>
...
<?php /**PATH /var/www/financial_test/resources/views/pdf/WarehouseTemplate.blade.php ENDPATH**/ ?>