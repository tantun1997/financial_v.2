<?php $__env->startSection('title', 'รายละเอียดแผนบำรุงรักษา'); ?>
...
<?php $__env->startSection('contents'); ?>
   ...
   <div class="row">
      <div class="col-lg-12">
         <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal" data-action="<?php echo e(route('maintenances.update', $E_PLAN->PLAN_ID)); ?>">
               แก้ไขข้อมูล
            </button>
            ...
            <div class="card-body">
               <div class="info-container">
                  ...
                  <div class="info-item">
                     ...
                     <span class="info-value"><?php echo e(\Carbon\Carbon::createFromFormat('d/m/Y H:i', $E_PLAN->CREATE_DATE)->addYears(543)->format('d/m/Y H:i')); ?>
      ...
      <div class="col-lg-12">
         <div style="display: flex; justify-content: flex-end; align-items: center; margin-bottom: 10px;">
            <div style="display: flex; align-items: center;">
               ...
               <button onclick="generatePdf(<?php echo e($E_PLAN->PLAN_ID); ?>, 'maintenances')" class="btn btn-danger mr-1">
                  <i class="fa-duotone fa-file-pdf fa-lg"></i> PDF
               </button>
               <?php if($E_PLAN->USAGE_STATUS_ID == 1 && Auth::user()->id == '114000041'): ?>
                  <form id="approval-form-<?php echo e($E_PLAN->PLAN_ID); ?>" action="<?php echo e(route('maintenances.approved', $E_PLAN->PLAN_ID)); ?>" method="POST">
                     <?php echo csrf_field(); ?>
                     ...
                     <?php $__currentLoopData = $EQUIP_LIST; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td style="text-align: center; vertical-align: middle;">
                              <form action="<?php echo e(route('maintenances.update_equip_used', $item->EQUP_ID)); ?>" method="POST">
                                 <?php echo csrf_field(); ?>
                                 <?php echo method_field('PATCH'); ?>
                                 <?php if($item->EQUP_CURRENT_PRICE == null): ?>
                                    <small style="color: red;">ใส่ราคา</small>
                                 <?php else: ?>
                                    <input type="checkbox" id="EQUP_USED_<?php echo e($item->EQUP_ID); ?>" name="EQUP_USED" <?php if($item->EQUP_USED == 1): ?> checked <?php endif; ?>>
                                 <?php endif; ?>
                           ...
                           <td style="text-align: left; white-space: nowrap; vertical-align: middle;">
                              <div class="form-container">
                                 <form action="<?php echo e(route('maintenances.update_equip', $item->EQUP_ID)); ?>" method="POST" class="equip-form" id="equip-form-<?php echo e($item->EQUP_ID); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
                                    <div class="view-mode">
                                    ...
                                    <form class="equip-form">
                                       <div class="edit-mode" style="display: none;">
                                          ...
                                          <div class="input-group">
                                             ...
                                             <input type="number" name="EQUP_QTY" value="<?php echo e(round($item->EQUP_QTY, 0)); ?>" min="1" step="1" class="form-control">
                                          </div>
                           ...
                           <td class="text-left">
                              แผนก: <?php echo e($item->TCHN_LOCAT_NAME); ?><br>
                              อายุการใช้งาน: <?php echo e(number_format($item->EQUP_AGE)); ?> ปี<br>
                              ราคาของวัสดุ: <?php echo e(number_format($item->EQUP_PRICE)); ?> บาท
                           </td>
                           ...
                           <td class="text-center align-middle">
                              ...
                              <div class="view-mode">
                                 <div class="btn-group" role="group">
                                    ...
                                    <form action="<?php echo e(route('maintenances.destroy_equip', $item->EQUP_ID)); ?>" method="POST" onsubmit="return confirm('Delete?')" class="p-0">
                                       <?php echo csrf_field(); ?>
   ...
   <?php echo $__env->make('maintenances.modal_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/financial_test/resources/views/maintenances/show.blade.php ENDPATH**/ ?>