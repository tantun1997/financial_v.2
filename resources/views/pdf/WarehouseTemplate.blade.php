...
<body>
    ...
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
        <tr>
            ...
            <td style="padding-left:50px; border-bottom: 1px dotted #999;">{{ $TCHN_LOCAT_NAME }}</td>
        </tr>
        <tr>
            <td width="50px"></td>
            <td colspan="2" style="word-break: keep-all;  text-align: justify;">
                ได้รับอนุมัติให้ดำเนินการตามแผนเงินบำรุง/งบประมาณ
                ประจำปี {{ $BUDG_YEAR }} โดยมีรายละเอียดดังนี้
            </td>
        </tr>
    </table>
    <table width="100%" style="vertical-align: top; padding-bottom: 3px;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: justify; word-spacing: -0.3px;">
                                {{ $count++ }}. <span style="border-bottom: 1px dotted #999;">
                                    {{ $EQUP['PRODCT_NAME'] }} </span> จำนวน
                                <span style="border-bottom: 1px dotted #999;">
                                    {{ number_format($EQUP['PRODCT_WITHDRAW_QTY'], 0) }}x{{ number_format($EQUP['PRODCT_CURRENT_PRICE'], 2) }}
                                </span> เป็นเงิน
                                <span style="border-bottom: 1px dotted #999;">
                                    {{ number_format($EQUP['PRODCT_WITHDRAW_QTY'] * $EQUP['PRODCT_CURRENT_PRICE'], 2) }}
                                </span>
            ...
            <td width="50%">
                ...
                <table width="100%" style="vertical-align: top; padding-bottom: 3px; font-size: 10pt;">
                    ...
                    <tr>
                        ...
                        <td>แผนเงินบำรุง/งบประมาณ ปี {{ $BUDG_YEAR }}</td>
                    </tr>
                    <tr>
